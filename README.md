...
Users must sign up with an account or log in to an existing one to access their shopping list or their pantry list, which is stored in a separate database.
